        ...
        <div class="card-body">
            <form>
                ...
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control" name="saldo_awal" id="saldo_awal" value="{{ $user->saldo_awal }}">
                </div>
                <div class="mb-2">
                    <label for="username">Saldo Akhir</label>
                    <input type="text" class="form-control" name="saldo_keluar" id="saldo_keluar" value="{{ $user->saldo_keluar }}">
                </div>
                <div class="mb-2">
